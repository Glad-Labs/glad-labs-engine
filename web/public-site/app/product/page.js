        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-800/40 rounded-xl p-8 border border-cyan-500/50 relative">
              ...
              <a
                href="#"
                className="block w-full text-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 font-medium"
              >
                Buy Guide
              </a>
            </div>
            ...
            <div className="bg-slate-800/40 rounded-xl p-8 border border-slate-700/50">
              ...
              <a
                href="#"
                className="block w-full text-center px-6 py-3 border border-cyan-500/50 text-cyan-400 rounded-xl hover:bg-cyan-500/10 transition-colors duration-300 font-medium"
              >
                Subscribe
              </a>
            </div>
